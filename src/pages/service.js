...
const ServicePage = ({ data }) => (
  <Layout>
    ...
    <div class="panel z-10 px-0 pt-32 bg-primary t-0 overflow-hidden relative min-h-screen md:h-auto sm:h-auto">
      <div class="panel-body min-h-screen  sm:min-h-auto xs:min-h-auto h-100 w-95 lg:w-90 -mt-24 lg:-mt-32 md:-mt-3  xs:mt-5 lg:mt-3 lg:pt-3 p-0 sm:mt-5 mx-auto md:w-90 xs:w-100 sm:w-95 relative">
        <div class="w-80 px-24 mx-auto py-32 bg-primary text-center">
          <img src={"/img/Untitled-1.png"} class="" />
          <div class="pt-18">
            <h1 class="text-center font-semiBold p-0 m-0 text-white text-4xl pb-24 xs:pb-0">
              Information gathering
            </h1>

            <p class="text-white text-center font-light leading-normal pt-4 m-0 text-base">
