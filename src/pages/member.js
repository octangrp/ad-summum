...
const MemberPage = ({ data }) => (
  <Layout>
    ...
    <div class="panel z-10 px-0 pt-32 bg-white t-0 overflow-hidden relative min-h-screen md:h-auto sm:h-auto">
      <div class="panel-body min-h-screen pt-32 sm:min-h-auto xs:min-h-auto h-100 w-95 lg:w-90 -mt-24 lg:-mt-32 md:-mt-3  xs:mt-5 lg:mt-3 lg:pt-3 p-0 sm:mt-5 mx-auto md:w-90 xs:w-100 sm:w-95 relative">
        <div class="pt-32">
          <div class="h-rem-74 w-rem-74 sm:h-64 sm:w-rem-64 xxs:h-48 xxs:w-rem-48 rounded-full overflow-hidden centered mx-auto my-2">
            <img src={"/img/lewis.jpg"} class="" />
          </div>
          <div class="w-80 mx-auto">
            <h5 class="my-2 text-black text-center p-0 m-">
              RUTAYISIRE Musoni Jean
            </h5>
            <h5 class="text-primary text-center p-0 m-0">Consultant</h5>
            <p class="text-black  text-center font-light leading-normal pt-4 m-0 text-base">
              ...
              happens in the rest of the paragraph. Before you can begin to
              determine what the composition of a particular paragraph will be,
              you must first decide on an argument and a working thesis
              statement for your paper. What is the most important idea that you
              are trying to convey to your reader? The information in each
              paragraph must be related to that idea. In other words, your
              paragraphs should remind your reader that there is a recurrent
              relationship between your thesis and the information in each
              ...
              in the paper. The decision about what to put into your paragraphs
              begins with the germination of a seed of ideas; this “germination
              ...
              your whole paper to crumble. So, let’s suppose that you have done
              some brainstorming to develop your thesis. What else should you
              keep in mind as you begin to create paragraphs?
            </p>
          </div>
        </div>
      </div>
