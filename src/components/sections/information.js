      ...
      <div class="w-50 h-60 border-8 border-grey relative">
          ...
          <div class="pt-4 px-5 relative">
            <ul class="list text-center w-100 lg:w-60  mr-auto p-0 m-0 hidden xl:block lg:block px-0 mr-0  text-sm">
              <li class="inline-block my-0 mr-8 text-5xl text-grey font-bold">1.</li>
              <li class="inline-block my-0 mr-8 text-5xl text-orange font-boldunderline">2.</li>
              <li class="inline-block my-0 mr-8 text-5xl text-grey font-bold">3.</li>
              <li class="inline-block my-0 mr-8 text-5xl text-grey font-bold">5.</li>
              </ul>
          </div>
        ...
        <div class="w-60 h-30 bg-white absolute t-40 r-20">
          <p class="text-black font-prina font-bold text-6xl">Discover where your leads come from, 
