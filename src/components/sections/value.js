         ...
         <div class="w-rem-30 sm:h-64 sm:w-rem-64 xxs:h-48 xxs:w-rem-48 overflow-hidden centered mx-auto my-2">
             <img src={'/img/Group-5.png'}/>
                 ...
                 <div class="panel-body bg-white center text-center py-2">
                     <h5 class=" my-1 color-accent xl:pt-4 lg:pt-3 font-bold font-primary text-xl md:text-base xs:text-xs sm:text-base sm:ml-3 xs:text-center sm:my-3 xs:my-3">Gakindi Vincent</h5> 
                     <div class="w-100  xl:pt-2 lg:pt-1 sm:ml-3 xs:text-center">
                       <p class="sm:text-xs md:text-sm text-lg left xs:text-xs xs:mx-auto xs:w-80 opacity-95">
                         Discover where your leads come from, what it costs to getthem, .</p></div>
                     </div>
                     </div> 
