...
const Main = ({ siteTitle }) => (
  ...
  <div class="panel-body min-h-screen  sm:min-h-auto xs:min-h-auto h-100 w-95 lg:w-90 -mt-24 lg:-mt-32 md:-mt-3  xs:mt-5 lg:mt-3 lg:pt-3 p-0 sm:mt-5 ml-auto md:w-90 xs:w-100 sm:w-95  relative">
...
your leads come from, them.</p>
          ...
          <div class="text-right w-70 ml-auto mr-12">
          <img src={'/img/rw-2009.gif'} class="w-5" />
          </div>
