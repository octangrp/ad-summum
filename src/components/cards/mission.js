...
class MissionCard extends React.Component {
  render() {
    ...
    return (
      <div class="w-30 lg:pr-0 xs:w-100 xs:pr-0 mr-auto border-none rounded-lg bg-white shadow p-8 lg:p-6 mb-12">
        ...
        <div class="pt-6">
          ...
          <p class="text-sm tracking-wider leading-relaxed text-justified xs:mr-5">
