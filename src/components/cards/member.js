    ...
    return (
      <div className="rounded-lg bg-transparent w-100 relative">
        ...
        <div className="bg-primary lg:h-rem-24 text-white p-4 absolute r-5 -b-5 w-80 md:r-0 md:w-100 md:l-35 md:p-1">
          <h5 className="mb-0 mt-0 text-xl lg:text-sm my-0 relative uppercase text-center leading-relaxed">
            {details.name}
          </h5>
          <div className="text-right relative">
            <div className="line absolute bg-white mt-3 inline-block xs:-mx-1"></div>
            <p className="text-base lg:w-100 xs:text-sm lg:text-xs md:text-base sm:text-sm my-0 inline-block mx-8 xs:mx-2 lg:mx-2 relative">
