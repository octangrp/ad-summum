...
class ValueCard extends React.Component {
  render() {
    ...
    return (
      <div className="pt-12 xl:w-30 xs:mx-auto lg:w-45 md:w-45 sm:w-45 md:mr-2 xs:w-80 rounded-lg overflow-hidden bg-transparent xl:inline-block lg:inline-block md:inline-block sm:inline-block sm:m-2 xl:m-2 lg:m-2 ">
        ...
        <div className="panel-body bg-white text-center pt-2 px-0">
