...
const Navbar = ({ siteTitle }) => (
  <nav class="z-99 transition-500ms w-100 text-primary absolute bg-transparent m-0 t-0 l-0 r-0  border-0 border-b-1 border-solid border-primary ">
    <div class="xl:w-90 lg:w-90 xs:w-90 sm:w-90 md:w-90 flex mx-auto py-0 mx-0">
      <ul class="list text-left w-70 lg:w-60  mr-auto p-0 m-0 hidden xl:block lg:block px-0 mr-0  text-sm">
        <li class="inline-block px-12 bg-primary text-white my-0 mr-5">
        ...
        <li class="inline-block  px-12 my-0 mr-5">
      ...
      <ul class="list text-right w-30 lg:w-60  mr-auto p-0 mt-3 hidden xl:block lg:block px-0 mr-0  text-sm">
